...
greet()
print("***Endof Chapter 4.1 Defining Functions\n")
...
greet2("Ada","Lovelace") #she's a mathematician
...
print("***End of Chapter 4.4 Keyword Arguments\n")
...
print("***End of Chapter 4.5 Default Arguments\n")
...
print("***End of Chapter 4.6 xargs\n")
...
#Chatper 4.9 Debugging
#Watch video and learn how to debug. Nothing to code.

#Chapter 4.10 and 4.11 VSCode Coding Tricks
# Watch video and learn. Nothing to do

#Chaper 4.12 Exercise / 4.13 Solution
def fizz_buzz(input):
...
print(fizz_buzz(3))
print(fizz_buzz(5))
print("***End of Chapter 4.12 Exercise / 4.13 Solution")
