...
#old way to swap variable values
x = 10
y = 11
z = x
x = y
...
y = 11
x,y = y, x
#assign two variable using this swap trick
a,b = 1,2
print("x",x)
print("y",y)
...
#two ways to make dictoinaries
nfl_teams={"Dallas":"Cowboys","New England":"Patriots","Green Bay":"Packers","Kansas City":"Chiefs","New Orleans":"Saints",}
print(nfl_teams)
#note with using dict() the key does not use quotes, the value does.
mlb_teams = dict(
    Boston="Red Sox",
    Houston="Astros",
    Chicago="Cubs",
...
#Chatper 5.20 Dictionary Comprehension
print("\nChapter 5.20 Dictionary COmprehension"+"-"*20)
...
#Chatper 5.21 Generator Expressions
print("\nChapter 5.21 Generator Expressions"+"-"*20)
#values = (x*2 for x in range(100000))
#print("gen:",getsizeof(values))
# values=[x*2 for x in the range(100000)]
#print("list:",getsizeof(values))

#Chatper 5.22 Unpacking Operator
