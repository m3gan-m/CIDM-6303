...
women_in_computing = ["Ada Lovelace", "Grace Hopoer", "Sister Mary Keller"]
...
# variab1es can be used as index numbers
i = 7
j = 8
...
#Looping thorugh a list of tuples using unpacking
...
#practice  
#vegies is mispelled by the way. VEGGIES
...
items=[("Product1",10),("Product2",9),("Product4",7),("Product3",12)]
#does not sort by quantity, only product name
items.sort()
print(items)
#sort by quantity
def sort_item(item):
    #sort by qty, which is index 1 in the list of tuples
    return item[1]
