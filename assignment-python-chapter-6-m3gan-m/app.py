...
print("\nChapter 6.2 Handling Exceptions")
print("\nTo test the errors, enter correct and bad values for age('z', -1, etc.)")
...
try:
    ...
    print("No exceptions were thrown.")
print("Execution continues.")
#Note the else clause it not required. use only if need it

# Chapter 6.3 Handling Different Exceptions
print("\nChapter 6.3 Handling Different Exceptions")
#multiple except clauses to handle multiple errors
#try inputting zero as age to see the message
try:
    age=int(input("Age: "))
    xfactor=10/age
except ValueError:
...
print("\nChapter 6.5 The With Statement")
#State that the with statement an close a file even if there is an error or not
